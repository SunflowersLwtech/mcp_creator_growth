...
def _detect_change_type(summary: str) -> str:
    ...
    keywords_map = {
        "security": ["security", "vulnerab", "auth", "permission", "sanitize", "escape", "inject"],
        "bugfix": ["fix", "bug", "issue", "error", "crash", "repair", "patch", "resolve"],
        "performance": ["performance", "optimize", "speed", "faster", "cache", "efficient", "memory"],
        "refactor": ["refactor", "restructure", "reorganize", "clean", "simplify", "rename"],
        "docs": ["document", "readme", "comment", "docstring", "doc"],
