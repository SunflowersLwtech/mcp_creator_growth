...
def _generate_default_quizzes(summary: str) -> list[dict[str, Any]]:
    """Generate default quiz questions based on summary."""
    return [
        {
        ...
        {
            "question": "What should you verify after this change?",
            "options": ["A) Unit tests pass", "B) Integration tests pass", "C) Manual testing", "D) All of the above"],
            "answer": "D",
            "explanation": "All verification methods should be used to ensure quality.",
        },
        {
            "question": "What is the potential risk of this change?",
            "options": ["A) Breaking existing functionality", "B) Performance regression", "C) Security vulnerability", "D) None of the above"],
            "answer": "A",
            "explanation": "Any code change has potential to break existing functionality.",
        },
    ]
